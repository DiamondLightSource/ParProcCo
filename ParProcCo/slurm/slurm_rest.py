...
#   filename:  slurm-rest-44.yaml
#   timestamp: 2026-06-11T15:12:31+00:00
...
class Hostlist(CsvString):
    pass


class HostlistString(CsvString):
    pass
...
class JobInfoGresDetail(CsvString):
    pass
...
class KillJobsMsgJobsArray(CsvString):
    pass
...
class QosPreemptList(CsvString):
    pass
...
class SelectedStepList(CsvString):
    pass
...
class StringArray(CsvString):
    pass


class StringList(CsvString):
    pass
...
class Uint32NoValStruct(Uint16NoValStruct):
    pass


class Uint64NoValStruct(Uint16NoValStruct):
    pass
...
class UpdateNodeMsg(BaseModel):
    ...
    """
    state: list[NextStateAfterRebootEnum] | None = None
    """
...
class Flag12(StrEnum):
    NONE = "NONE"
    DELETED = "DELETED"


class UserShort(BaseModel):
    adminlevel: list[AdministratorLevelEnum] | None = None
    """
...
class Flag13(StrEnum):
    DELETED = "DELETED"


class Flag14(StrEnum):
...
class KillJobsMsg(BaseModel):
    ...
    """
    flags: list[KillWarningFlag] | None = None
    """
    ...
    """
    job_state: list[CurrentEnum] | None = None
    """
...
class PartitionInfo(BaseModel):
    ...
    qos: Qos | None = None
    select_type: list[SelectTypeEnum1] | None = None
    """
...
class ProcessExitCodeVerbose(BaseModel):
    ...
    status: list[StatusEnum1] | None = None
    """
...
class Preempt(BaseModel):
    ...
    """
    list_1: QosPreemptList | None = Field(None, alias="list")
    """
...
class StepTresReqMax(TresList):
    pass


class StepTresReqMin(TresList):
    pass


class StepTresUsageMax(TresList):
    pass


class StepTresUsageMin(TresList):
    pass
...
class Nodes(BaseModel):
    ...
    """
    list_1: str | None = Field(None, alias="list")
    """
    Node(s) allocated to the job
    """
    select_type: list[SelectTypeEnum] | None = None
    """
...
class JobRes(BaseModel):
    ...
    select_type: list[SelectTypeEnum1]
    """
    Scheduler consumable resource selection type
    """
...
class OpenapiKillJobsResp(OpenapiKillJobResp):
    pass
...
class Step(BaseModel):
    ...
    """
    state: list[CurrentEnum] | None = None
    """
    Current state
    """
